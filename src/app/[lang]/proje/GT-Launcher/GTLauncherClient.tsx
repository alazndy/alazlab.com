      ...
      <section className="apple-card p-8 sm:p-12 md:p-14 space-y-8 relative overflow-hidden">
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2">
          <a
            ...
            download
            className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl font-bold text-xs uppercase tracking-wider bg-apple-orange text-white hover:opacity-90 active:scale-95 transition-all shadow-lg shadow-orange-500/25"
          >
            <Download className="w-4 h-4" />
            <span>{t('project.downloadApk')} (18.2 MB)</span>
          </a>
          <a
